...
plugin (currently `@openai/codex` `0.155.1`):
...
<Note>
The current bundled harness is `@openai/codex` `0.155.1`. A clean-home
`model/list` probe against that bundled app-server included these public picker rows:

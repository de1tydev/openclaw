...
5. Set `channels.synology-chat.webhookUrl` in your config to the exact public outgoing-webhook URL recorded above.
6. Restart the Gateway and send a DM to the Synology Chat bot.
